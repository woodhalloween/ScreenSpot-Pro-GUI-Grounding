...
from llava.mm_utils import tokenizer_image_token,process_anyres_ui_image
...
#         # print("DEBUG: data_args",data_args)
#
#     def __len__(self):
...
#
#             # print("DEBUG: image_aspect_ratio", self.data_args.image_aspect_ratio)
...
#                 # print("GET anyres in train.py")
#                 # width, height = image.size
#                 # print("original width and height: ",width,height)
...
#             if (self.data_args.image_aspect_ratio == 'anyres_ui' or self.data_args.image_aspect_ratio == 'anyres_ui_fusion'):
#                 data_dict['image_size']=new_size
#                 # if new_size==(224,224):
#                 #     print("DEBUGGGGG: data_dict['image_size']=new_size: ",new_size)
#             else:
...
class LazySupervisedDataset(Dataset):
    ...
    def lengths(self):
        length_list = []
        for _, sample in self.data_df.iterrows():
            img_tokens = 128 if 'image' in sample else 0
            length_list.append(sum(len(conv['value'].split()) for conv in json.loads(sample['conversations'])) + img_tokens)
        return length_list
